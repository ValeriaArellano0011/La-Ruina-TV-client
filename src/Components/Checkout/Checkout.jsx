                ...
                <div className={s.divCheckCont}>
                  ...
                  <div className={s.divDescription}>
                    <ul>
                      <h5>
                        <li>
                          <img src="" alt="" /> Acceso a todo nuestro contenido mediante plataformas comerciales
                        </li>
                        <li>
                          <img src="" alt="" /> Debes suscribirte a nuestro canal de Youtube
                        </li>
                      </h5>
                    </ul>                  </div>
                ...
                <div className={s.divCheckCont}>
                  ...
                  <div className={s.divDescription}>
                    <ul>
                      <h5>
                        <li>
                          <img src="" alt="" /> Acceso a todo nuestro contenido sin anuncios
                        </li>
                        <li>
                          <img src="" alt="" /> Reproduce tus canciones en cualquier lugar, incluso sin conexión
                        </li>
                      </h5>
                    </ul>
                  </div>
                  ...
                  <div className={s.divDescription}>
                    <ul>
                      <h5>
                        ...
                        <li>
                          <img src="" alt="" /> Adquiere nuestro reproductor integrado para desplazarte por cualquier lugar sin dejar de escuchar tu música favorita
                        </li>
                      </h5>
                    </ul>
                  </div>
