...
export const YtSubscribeButton = () => {
    ...
    return(
        <div className={s.canvasYtSubBtn} id='canvasYtSubBtn'>
            <ul style={{display:'flex', flexDirection:'column', justifyContent:'center', textAlign: 'center'}}>
                <li><h1 style={{color:'white'}}>¡Debes suscribirte a nuestro canal de youtube para ver este contenido!</h1></li><br/>
